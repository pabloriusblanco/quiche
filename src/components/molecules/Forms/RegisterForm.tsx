...
const RegisterForm: React.FC<RegisterFormProps> = ({
  ...
  const handleSubmit = async (values: {
    ...
    const { username, name, lastname, email, phone, password } = values;
  ...
  console.log(!formik.isValid ? "gray" : "primary");

  return (
    <RegisterFormContainer>
      <form
        onSubmit={formik.handleSubmit}
        className="col-span-12 grid max-h-[80vh] grid-cols-12 gap-5 "
      >
        <div className="col-span-12 grid grid-cols-12 gap-5 overflow-y-auto">
